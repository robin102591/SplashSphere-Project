...
const plans = [
  {
    ...
    features: [
      ...
      'Supply tracking',
      'Customer-facing display (1 station)',
      'Email support',
    ],
  },
  {
    ...
    features: [
      ...
      'Customer-facing display (3 stations per branch, 5 promo messages)',
  ...
  },
  {
    ...
    features: [
      ...
      'Per-branch customer-display overrides + unlimited stations',
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: 'Customer-Facing Display', starter: true, growth: true, enterprise: true },
  { feature: 'POS Stations per Branch', starter: '1', growth: '3', enterprise: 'Unlimited' },
  { feature: 'Display Promo Messages', starter: '1', growth: '5', enterprise: '20' },
  ...
  { feature: 'Branch Display Overrides', starter: false, growth: false, enterprise: true },
