    ...
    <div className="min-h-[100svh] flex items-center justify-center p-6">
      <div className="text-center max-w-sm">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-primary text-primary-foreground font-medium px-6 py-3 rounded-lg text-sm hover:bg-primary/90 transition-colors active:scale-[0.97]"
        >
