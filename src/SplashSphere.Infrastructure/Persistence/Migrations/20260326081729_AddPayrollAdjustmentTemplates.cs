...
{
    /// <inheritdoc />
    public partial class AddPayrollAdjustmentTemplates : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PayrollAdjustmentTemplates",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayrollAdjustmentTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayrollAdjustmentTemplates_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollAdjustmentTemplates_TenantId",
                table: "PayrollAdjustmentTemplates",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_PayrollAdjustmentTemplates_TenantId_Name",
                table: "PayrollAdjustmentTemplates",
